...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cloudwpss23OpenapiCyan.PostUserRequest();
  });
  ...
  describe('PostUserRequest', function() {
    it('should create an instance of PostUserRequest', function() {
      // uncomment below and update the code to test PostUserRequest
      //var instance = new Cloudwpss23OpenapiCyan.PostUserRequest();
      //expect(instance).to.be.a(Cloudwpss23OpenapiCyan.PostUserRequest);
    });
